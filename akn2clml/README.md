...
2. [akn2clml.xsl](https://bitbucket.org/tsoltd/tna.legislation.transformations.akn/src/main/akn2clml/src/main/resources/transform/akn2clml.xsl) - second pass containing the majority of the transformation logic (contained in this XSLT file and in other modules included from this folder).
3. [add-data.xsl](https://bitbucket.org/tsoltd/tna.legislation.transformations.akn/src/main/akn2clml/src/main/resources/transform/add-data.xsl) - final pass optionally adding in the schemaLocation, publisher metadata and ISBN metadata if available (passed in as XSLT parameters)
