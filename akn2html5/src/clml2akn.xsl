				...
				<FRBRauthor>
					<xsl:attribute name="href">
						...
						<xsl:choose>
							...
							<!--<xsl:when test="$ukm-doctype = 'UnitedKingdomPrivateOrPersonalAct'">legislature/UnitedKingdomParliament</xsl:when>
							<xsl:when test="$ukm-doctype = 'GreatBritainPrivateOrPersonalAct'">legislature/UnitedKingdomParliament</xsl:when>
							<xsl:when test="$ukm-doctype = 'GreatBritainLocalAct'">legislature/UnitedKingdomParliament</xsl:when>-->
				...
				<FRBRcountry>
					<xsl:attribute name="value">
						<xsl:choose>
							...
							<!--<xsl:when test="$ukm-doctype = 'UnitedKingdomPrivateOrPersonalAct'">GB-UKM</xsl:when>
							<xsl:when test="$ukm-doctype = 'GreatBritainPrivateOrPersonalAct'">GB-UKM</xsl:when>
							<xsl:when test="$ukm-doctype = 'GreatBritainLocalAct'">GB-UKM</xsl:when>-->
				...
				<FRBRname>
					<xsl:attribute name="value">
						...
						<xsl:choose>
							...
							<!--<xsl:when test="$ukm-doctype = 'UnitedKingdomLocalAct' or $ukm-doctype = 'UnitedKingdomPrivateOrPersonalAct' or $ukm-doctype = 'GreatBritainPrivateOrPersonalAct' or $ukm-doctype = 'GreatBritainLocalAct'">-->
